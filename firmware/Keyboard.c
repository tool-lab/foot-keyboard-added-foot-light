...
//
// Control the foot light
//
// Parameter is set to hid_report_out[1]
//   0: Off
//   1: On
// Currently just toggle the light
void ControlFootLight(void)
{
#if 0
    if(hid_report_out[1])
    ...
    // Just toggle the LED
    // Above #if0-#endif implementaion is final version
